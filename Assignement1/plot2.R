...
any(usefulData=="?")
png(file="plot2.png",bg =NA,width = 480, height = 480, units = "px",type =  "cairo")
with(usefulData,plot(DateTime,Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab=""))
dev.off()
